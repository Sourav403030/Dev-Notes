...
Last edited time: December 19, 2025 10:12 PM
Status: Done
...
- It is used when you want **multiple asynchronous operations to run in parallel** and you need the **result only after all of them succeed**.
    - Takes **an iterable (usually an array) of promises.**
    - Returns **a single promise.**
    - That Promise -
        - **resolves** when **all promises resolve.**
        - rejects immediately if any one of the promise rejects.
